...
const ResumeFeature = () => {
    ...
    return (
        <div>
            <ToastContainer />
            <div className='flex justify-center items-center p-10 border rounded-lg bg-pink-100 animate-pulse hover:scale-105 hover:shadow-md cursor-pointer transition-all min-h-[200px]'
                ...
                <DialogContent className="max-w-2xl">
                    <DialogHeader className="relative">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="bg-gray-200 text-gray-700 text-xs font-bold py-1 px-2 rounded-full">Advanced</span>
                        </div>
                        <DialogDescription>
                            <form onSubmit={onSubmit}>
                                <div>
                                    ...
                                    <div className='my-3'>
                                        ...
                                        <div className="relative font-semibold">
                                            ...
                                            >
                                                Choose File
                                                <Image src='/images/crown.png' width={25} height={25} />
                                            </Button>

                                            {resumeFile && (
                                                <p className="mt-1 ml-2 text-gray-700">Selected file: {resumeFile.name}</p>
                                            )}
                                        </div>
                                    </div>
                                </div>
                                <div className='flex gap-5 justify-end'>
                                    ...
                                    <Button type="submit" disabled={loading}>
                                        {loading ? <><LoaderCircle className='animate-spin' /> Generating from AI</> : 'Start Your AI Interview'}
                                    </Button>
                                </div>
                            </form>
                        </DialogDescription>
