...
const Feedback = ({params}) => {
  ...
  return (
    <div className='p-10 mt-20'>
      ...
      <h2 className='font-bold text-lg text-red-500'>No interview Feedback</h2>
      : <>
      ...
      {feedbackList&&feedbackList.map((item,index)=>(
        ...
        <CollapsibleContent>
          <div className='flex flex-col gap-2'>
            ...
            <h2 className='p-2 border rounded-lg bg-green-50 text-sm text-green-900'><strong>AI Answer: </strong>{item.correctAns}</h2>
